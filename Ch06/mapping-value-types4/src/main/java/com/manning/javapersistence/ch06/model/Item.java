...
public class Item {
    ...
    /*
     * The <code>Item</code> entity defaults to field access, the <code>@Id</code>
     * is on a field.
     */
    @Id
    ...
    /*
     * The <code>@Access(AccessType.PROPERTY)</code> setting on the
     * <code>name</code> field switches this
     * particular property to runtime access through getter/setter methods by the
     * JPA provider.
     */
    ...
    @OneToMany(mappedBy = "item", cascade = CascadeType.PERSIST, orphanRemoval = true) // Includes CascadeType.REMOVE
    ...
    /*
     * Hibernate will call <code>getName()</code> and <code>setName()</code> when
     * loading and storing items.
     */
