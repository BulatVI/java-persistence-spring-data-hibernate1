...
public class MonetaryAmountUserType
    ...
    /**
     * Hibernate calls <code>disassemble</code> when it stores a value in the global
     * shared second-level
     * cache. We need to return a <code>Serializable</code> representation. For
     * <code>MonetaryAmount</code>,
     * a <code>String</code> representation is an easy solution. Or, because
     * <code>MonetaryAmount</code> is actually
     ...
     * representation. Or, if we have stored a serialized
     * <code>MonetaryAmount</code>,
     ...
     * immutable, like <code>MonetaryAmount</code>, we can simply return the
     * original.
     */
    @Override
     ...
     * in the query result, and create a new instance of
     * <code>MonetaryAmount</code>.
     */
     ...
     * provided <code>PreparedStatement</code>. (Unless the
     * <code>MonetaryAmount</code>
